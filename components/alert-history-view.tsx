...
export function AlertHistoryView() {
  ...
  const [filteredAlerts, setFilteredAlerts] = useState<HistoryAlert[]>([])
  ...
  const getBadgeVariant = (nivel: string) => {
    return nivel === 'error' ? 'destructive' : 'outline'
  }
    ...
    <div className="flex-1 overflow-auto p-6 bg-background">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Histórico de Alertas</h1>
            <p className="text-muted-foreground">
              Relatório completo de alertas gerados pelo sistema
            </p>
          </div>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-2xl font-bold">{stats.arCondicionado}</p>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-2xl font-bold">{stats.luzes}</p>
          ...
          <CardHeader>
            ...
            <CardDescription>
              {filteredAlerts.length === 0 ? 
                ...
                `Mostrando ${filteredAlerts.length} de ${alertHistory.length} alertas`
              }
            </CardDescription>
          </CardHeader>
          <CardContent>
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <Badge variant={getBadgeVariant(alert.nivel)} className="text-xs">
                              {alert.nivel === 'error' ? 'Erro' : 'Aviso'}
                            </Badge>
